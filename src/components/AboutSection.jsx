...
export default function AboutSection() {
    ...
    const timelineData = [
        ...
        { year: "2021", title: "Implementación Estratégica & CRM", desc: "Trabajo conjunto con equipo de desarrollo externo para la implementación y 'tunning' de un CRM personalizado. Mi rol se basó en la traducción de las necesidades operativas, ajustando apartados técnicos y validando cada entrega, asegurando la adopción del sistema.", meta: "CRM_DEPLOY // DEV_SYNC" },
